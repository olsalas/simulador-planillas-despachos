            ...
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                <div class="rounded-lg border border-dashed border-gray-300 bg-white p-6 shadow-sm">
                    <p class="text-sm text-gray-700">
                        Pantalla dummy MVP. Aquí se conectará la carga manual de facturas CSV
                        asignadas a conductor.
                    </p>
                    <p class="mt-2 text-xs text-gray-500">
                        Próximo paso: validación de formato, preview y creación de batch.
                    </p>
                </div>
